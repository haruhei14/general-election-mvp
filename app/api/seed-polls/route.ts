...
const SEED_POLLS = [
    {
        id: 'oshinoko-miyako-2026',
        title: '実写版『推しの子』ミヤコ役に倉科カナ！実写化で一番センスが出る配役は？',
        genre: 'エンタメ',
        description: '実写化作品において、あなたが「一番キャスティングのセンスが出る」と思うポジションはどこ？',
        poll_type: 'daily_trend',
        tags: ['推しの子', '実写化', '倉科カナ', 'キャスティング', '芸能'],
        image_url: '/ogp-oshinoko-miyako.png',
        explanation: {
            background: '2026年1月22日、世界的なヒット作『【推しの子】』の実写化プロジェクトにおいて、重要な役割を担う斉藤ミヤコ役に倉科カナさんが決定しました。ミヤコは、主人公・アクアとルビーを育てる「育ての親」であり、芸能界の裏表を知り尽くしたタフさと、母性を併せ持つ非常に魅力的なキャラクターです。本日公開されたビジュアルでは、彼女の洗練された美しさとどこか憂いのある表情が見事に再現されており、SNSでは「これぞ実写化の正解」「サブキャラにこのクラスを置く制作陣の本気を感じる」と、トレンドを席巻しています。',
            psychology: '実写化において、主役のキャスティングに注目が集まるのは当然です。しかし、近年のヒット作（『キングダム』や『ゴールデンカムイ』など）を振り返ると、共通しているのは「脇を固める俳優陣の圧倒的なハマり具合」です。主役以上に、原作ファンが「このキャラを誰がやるのか？」と密かに楽しみにしているのがサブキャラ。そこに見事な配役がなされると、ファンは「制作陣は本当に原作を読み込んでいる」という信頼を抱きます。',
            modern: 'アニメ的なビジュアルをそのまま再現しようとすると、往々にしてコスプレ感が出てしまいます。しかし、実写映画としての深みを出すには、現実の人間としての説得力が必要です。倉科カナさんのような確かな演技力を持つ俳優が、そのキャラクターの「魂」を演じることで、二次元の記号が三次元の人間へと昇華されます。',
            trivia: 'SNS時代において、制作陣の「原作愛」はすぐに可視化されます。安易な人気取りの配役はすぐに見抜かれ、逆に「この役にはこの人しかいない」という熱意ある配役は、かつてないほどの応援（拡散）を得ます。',
            summary: '実写化は、原作のコピーではなく、新しい解釈の提示です。あなたが最も「配役の妙」を感じ、作品に没入するきっかけになるのは、どのキャラクターの登場シーンですか？倉科カナさんのミヤコ役決定を祝しつつ、皆さんが実写化作品に求める「最高の配役」への想いを投票してください。'
        },
        options: [
            { id: '1', label: '主役（主人公）（やはり作品の顔。ここが似ていないと始まらない）', votes: 0 },
            { id: '2', label: 'ライバル・敵役（物語を引き締める鍵。圧倒的なカリスマ性が必要）', votes: 0 },
            { id: '3', label: '重要サブキャラ（ミヤコ等）（世界観のリアルさを支える。ここが完璧だと感動する）', votes: 0 },
            { id: '4', label: 'あえての「意外な配役」（イメージと違っても、演技力でねじ伏せてほしい）', votes: 0 },
        ]
    },
    {
        id: 'senbatsu-march-2026',
        title: 'センバツ入場行進曲がSNS流行歌に決定！あなたは『伝統にふさわしい曲』をどう考える？',
        genre: 'エンタメ',
        description: 'M!LKの「イイじゃん」がセンバツ入場行進曲に決定し、SNSで賛否両論。あなたの意見は？',
        poll_type: 'daily_trend',
        tags: ['センバツ', '高校野球', 'MILK', 'イイじゃん', '行進曲'],
        image_url: '/ogp-senbatsu.png',
        explanation: {
            background: '2026年1月21日、第98回選抜高校野球大会の運営委員会が開かれ、入場行進曲がダンスボーカルユニット・M!LKの「イイじゃん」に決定しました。この曲は「今日ビジュいいじゃん」というキャッチーなフレーズに合わせて踊る動画がTikTokで大流行し、昨年末の紅白歌合戦でも披露されたSNS時代の象徴的なヒット曲です。しかし、この決定が報じられるやいなや、SNS上では「軽すぎる」「一生の思い出が台無しだ」といった厳しい意見が続出しています。',
            psychology: '批判の矢面に立っているのは、「SNSでバズっただけの曲」というレッテルです。伝統を重んじる層からは、泥にまみれて白球を追う高校球児のイメージと、TikTokのキラキラした世界観が乖離しているとの指摘があります。しかし、歴史を紐解けば、宇多田ヒカルの「First Love」や寺尾聰の「ルビーの指環」といった恋愛ソングも行進曲として採用されてきました。時代ごとの「一番の流行」を取り入れることこそが、センバツの真の伝統であるという見方もできます。',
            modern: '今回の論争の根底には、高校野球に対する日本社会の「聖域化」があります。球児たちには常に「清廉潔白」で「ストイック」であることを求めるあまり、若者のリアルな流行であるSNS文化を「不純なもの」として排除しようとする心理が働いているのではないか、という分析もあります。現代の若者は「純粋さ」と「戦略的な自己プロデュース」を巧みに使い分けており、大人たちが抱く「球児像」とのギャップが広がっているのかもしれません。',
            trivia: 'かつては「歩きやすさ（テンポ）」が最優先された行進曲ですが、現在では大会のブランドイメージや、若年層へのアピールという側面も強まっています。吹奏楽アレンジされることでどのような「重厚さ」を持つのか、編曲の妙も注目されています。',
            summary: '甲子園の土を踏む球児たちにとって、人生で一度きりの入場行進。その背景に流れるのは、最新の流行歌か、それとも時代を超えた名曲か。あなたがもし選曲委員なら、未来を担う球児たちにどのような旋律を贈りますか？'
        },
        options: [
            { id: '1', label: '今の流行曲でいい（その時代のヒット曲を使うのが伝統だ）', votes: 0 },
            { id: '2', label: 'もっと厳かな曲がいい（高校生の一生の思い出、重みが必要だ）', votes: 0 },
            { id: '3', label: '曲のメッセージ性による（歌詞の内容が野球や青春に合っているべき）', votes: 0 },
            { id: '4', label: 'そもそもクラシックや軍歌風でいい（行進曲としての機能性を重視すべき）', votes: 0 },
        ]
    },
    {
        id: 'fx-kurumi-anime-2026',
        title: '本日『FX戦士くるみちゃん』アニメ化発表！あなたが一番見たい『スリル系』アニメは？',
        genre: 'エンタメ',
        description: '投資の恐怖を描く本作のように、あなたがアニメで観て「一番ハラハラ・ワクワクする」のはどのジャンル？',
        poll_type: 'daily_trend',
        tags: ['FX戦士くるみちゃん', 'アニメ', '投資', 'ギャンブル', 'デスゲーム'],
        image_url: '/ogp-fx-kurumi.png',
        explanation: {
            background: '本日、でむにゃん氏（原作）と炭酸だいすき氏（作画）による人気漫画『FX戦士くるみちゃん』が、2026年に待望のTVアニメ化を果たすことが発表されました。主人公・福賀くるみ役には鈴木愛奈さんが決定し、「あの絶望の叫びをどう演じるのか」と期待の声が上がっています。公開されたティザービジュアルには、笑顔でトレードを楽しむ姿と、強制ロスカットを食らい瞳から光が消えた「絶望の表情」の2パターンがあり、SNSでは投資未経験者からも強烈なインパクトを与えています。',
            psychology: '本作の最大の特徴は、一見すると「可愛い女子大生のゆるふわな日常系」のようなビジュアルでありながら、その中身は2000万円という巨額の損失を取り戻そうとする、血の気の引くような本格マネーゲームである点です。投資という、一瞬の判断で人生が暗転しかねない現代的な恐怖が、可愛らしいキャラクターを通じて描かれることで、視聴者は安全な場所から「極限の心理状態」を追体験できるのです。',
            modern: '近年、投資やギャンブル、あるいはデスゲームを題材にした作品が高い人気を博しています。なぜ私たちはキャラクターが苦しむ姿に惹かれるのでしょうか。そこには、日常では味わえない「全か無か」の緊張感への欲求や、失敗から学ぶ擬似的な教訓、そして何より「自分じゃなくてよかった」という一種の安堵感が存在します。',
            trivia: '『FX戦士くるみちゃん』の原作者は「私の負のエネルギーから生まれた」と語っており、その剥き出しの感情がファンの共感を呼んでいます。2026年現在は「誰にでも起こりうる現実の落とし穴」を突きつける作品が支持されています。',
            summary: '手に汗握る投資の乱高下か、命を賭けた極限の対決か。あなたがアニメを通じて最も味わいたい、脳が痺れるような「スリル」はどこにありますか？くるみちゃんの「強制ロスカット」を他山の石とするか、それとも共感して共に泣くか。あなたの1票で、今ファンが求めている「ハラハラ」の正体を可視化しましょう。'
        },
        options: [
            { id: '1', label: '投資・マネーゲーム系（FX、株、仮想通貨など現実のヒリヒリ感）', votes: 0 },
            { id: '2', label: '命懸けのデスゲーム系（裏切りの心理戦や生き残り）', votes: 0 },
            { id: '3', label: 'カジノ・伝統博打系（ポーカー、麻雀、丁半博打など）', votes: 0 },
            { id: '4', label: 'スポーツ・勝負事系（絶対に負けられない一戦、逆転劇）', votes: 0 },
        ]
    },
    {
        id: 'live-action-goldenkamuy-2026',
        title: '本日『ゴールデンカムイ』続編始動！実写化で一番外せない要素は？',
        genre: 'エンタメ',
        description: '漫画やアニメの実写化、あなたが一番「これだけは妥協してほしくない」と思うポイントは？',
        poll_type: 'daily_trend',
        tags: ['ゴールデンカムイ', '実写化', '映画', 'ドラマ', '山﨑賢人'],
        image_url: '/ogp-live-action.png',
        explanation: {
            background: '2026年1月18日、映画版が大ヒットを記録した『ゴールデンカムイ』の物語が、ドラマシリーズとして再び動き出しました。実写化プロジェクトは往々にして原作ファンの厳しい目にさらされますが、本作はキャスト陣の圧倒的なビジュアル再現度と、アイヌ文化への深いリスペクトを感じさせる丁寧な描写により、異例の「大絶賛」を浴び続けています。',
            psychology: 'かつての実写化は「コスプレ感」と揶揄されるような、表面的なビジュアル再現に終始することが少なくありませんでした。しかし、SNSで誰もが批評家になれる現代において、ファンが求めているのは「そのキャラクターがそこに生きているか」という説得力です。体格作りから立ち振る舞いまで、俳優自身の徹底的な役作りが評価の大きな分かれ道となっています。',
            modern: '限られた尺の中で膨大な原作エピソードをどう再構成するか。これは実写化における最大の難所です。最近の成功例に共通しているのは、エピソードをただなぞるのではなく、「その作品が最も伝えたい核心部分はどこか」を制作陣が正確に把握している点です。',
            trivia: '実写化の是非を分ける最後の鍵は、制作陣がどれほど「一ファンとして」その作品を愛しているか、という熱量です。ロケ地の選定、衣装の質感、劇伴の使い方一つとっても、原作愛は画面越しに伝わります。',
            summary: 'かつては「タブー」視されることもあった実写化ですが、今や日本のエンターテインメントを牽引する重要なジャンルとなりました。あなたが実写化作品を観る際、最も心を動かされるポイントはどこですか？'
        },
        options: [
            { id: '1', label: 'ビジュアルの再現度（キャラの見た目や衣装、体格の一致）', votes: 0 },
            { id: '2', label: '内面・演技の解釈（俳優の演技力やキャラクターへの理解度）', votes: 0 },
            { id: '3', label: '脚本・構成の完成度（原作の魂を壊さない構成や台詞）', votes: 0 },
            { id: '4', label: '制作陣の「原作愛」（細かな小道具や背景、演出へのこだわり）', votes: 0 },
        ]
    },
    {
